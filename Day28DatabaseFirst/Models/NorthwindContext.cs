...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<NewEmployees2> NewEmployees2s { get; set; }
    ...
    public virtual DbSet<ProductsTest> ProductsTests { get; set; }
    ...
    public virtual DbSet<VwShowEmployee> VwShowEmployees { get; set; }

    public virtual DbSet<VwShowOrder> VwShowOrders { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.\\EDPI2024R2;Initial Catalog=Northwind;Integrated Security=true;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DayTran>(entity =>
        {
            entity.HasNoKey();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC27CFCC96E7");

            entity.ToTable("EmployeesCase");
        ...
        modelBuilder.Entity<MonthTran>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.Gtotal).HasColumnType("decimal(9, 2)");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Name).HasMaxLength(50);
            entity.Property(e => e.Total)
                .HasColumnType("decimal(9, 2)")
        ...
        modelBuilder.Entity<NewEmployees2>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("NewEmployees2");
        ...
        modelBuilder.Entity<P2>(entity =>
        {
            ...
            entity.Property(e => e.Categoryname).HasMaxLength(15);
            entity.Property(e => e._1996).HasColumnName("1996");
            entity.Property(e => e._1997).HasColumnName("1997");
            entity.Property(e => e._1998).HasColumnName("1998");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC27F7D39E4D");

            entity.ToTable("ProductsTest");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__test__3214EC27E49C2EA1");
        ...
        modelBuilder.Entity<VwShowEmployee>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_ShowEmployees");
        ...
        modelBuilder.Entity<VwShowOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw_ShowOrder");
